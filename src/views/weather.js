...
//   //const [state, setState] = useState(props.fetchedItem);
...
// //             </h6>
// //             <p style={{ textShadow: "0 0 1.5rem white" }}>
// //               Your local time is: {state.location.localtime}{" "}
// //               {state.location.tz_id} timezone
// //             </p>
// //             <p
// //               style={{
// //                 padding: "3vh 0",
